    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            % configurado × lucro (Faturamento − Investimento − Custo da equipe).
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          <p className="text-2xl font-semibold mt-1 text-success flex items-center gap-2">
            <Receipt className="h-5 w-5" /> {brl(totalCommission)}
          </p>
        </div>
        <div className="rounded-2xl border border-border bg-card p-5">
          <p className="text-[10px] uppercase tracking-wider text-muted-foreground">Lucro consolidado</p>
          <p className="text-2xl font-semibold mt-1 flex items-center gap-2">
            <TrendingUp className="h-5 w-5 text-primary" /> {brl(totalProfit)}
          </p>
        </div>
        <div className="rounded-2xl border border-border bg-card p-5">
